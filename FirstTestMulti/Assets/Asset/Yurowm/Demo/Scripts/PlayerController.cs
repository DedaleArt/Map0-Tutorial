...
public class PlayerController : MonoBehaviour
{
	...
	private void Move()
	{
		...
		m_Rigidbody.MovePosition(m_Rigidbody.position + movement * m_Speed * Time.deltaTime);
		transform.LookAt(m_Rigidbody.position + movement * m_Speed * Time.deltaTime);
	...
	void OnTriggerEnter(Collider other)
	{
		...
		if (other.gameObject.CompareTag ("Endup"))
		{
			SceneManager.LoadScene(SceneManager.GetActiveScene().buildIndex-1);
		}
